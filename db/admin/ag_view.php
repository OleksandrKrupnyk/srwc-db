...
$viewMenuitem[1] = "<li class=\"inactive\"><a href=\"action.php?action=view&who=invitation\">Запрошені</a></li>\n";
$viewMenuitem[2] = "<li class=\"inactive\"><a href=\"action.php?action=view&who=tesis\">З тезами</a></li>\n";
$viewMenuitem[3] = "<li class=\"inactive\"><a href=\"action.php?action=view&who=arrival\">Прибули</a></li>\n";
$viewMenuitem[4] = "<li class=\"inactive\"><a href=\"action.php?action=view&who=introduction\">Впроваджені</a></li>\n";
$viewMenuitem[5] = "<li class=\"inactive\"><a href=\"action.php?action=view&who=public\">З публікацією</a></li>\n";
$viewMenuitem[6] = "<li class=\"inactive\"><a href=\"action.php?action=view&who=comments\">Примітки</a></li>\n";
$viewMenuitem[7] = "<li class=\"inactive\"><a href=\"action.php?action=view&who=raiting\">За рейтингом</a></li>\n";


if (isset($_GET['who'])) {
    $viewMenuitem[0] = "<li class=\"inactive\"><a href=\"action.php?action=view\">Всі</a></li>\n";
    switch ($_GET['who']) {
        case "invitation": {
