...
<form class="addautorForm" method="post" action="action.php" name='Autor' >
    ...
    <br>
    <label>ПІБ</label>
    <input type="text" name="Autor[suname]" title="Прізвище" placeholder="Прізвище" required>
    <input type="text" name="Autor[name]" title="Ім'я" placeholder="Ім'я" id="name" required>
    <input type="text" name="Autor[lname]" title="По-батькові" placeholder="По-батькові" id="lname">
    <br>
    <fieldset>
        <legend>Данні автора</legend>
        <select size="1" name="Autor[curse]" title="Курс навчання">
        ...
        <input type="email" name="Autor[email]" title="Наприклад:user@mail.ru" placeholder="Электронна скринька">
        <label>Телефон:</label>
        <input type="tel" pattern="\d{10}" size="10" maxlength="10" name="Autor[phone]" title="Наприклад:0985622012"
