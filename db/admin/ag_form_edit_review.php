...
?>
<header><a href="action.php?action=view#id_w<?= $row['id_w']?>">Усі роботи</a></header>
...
<form class="addreviewForm" method="post" action="action.php"
    ...
    <input type="button" value="Повернутися" onclick="window.location='action.php?action=view#id_w'+<?= $row['id_w']?>">
