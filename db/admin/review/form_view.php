...
<header>Перегляд рецензії</header>
    <h1><?= $row['title']?></h1>
    <table>
        <tr><th>#</th><th>Показник</th><th>Бали</th></tr>
        <tr>
        ...
        <tr>
            ...
            <td><?= $row['tendentious']?></td></tr>
        <tr>
            <td>12</td><td>Сума.</td><td><?= $row['sumball']?></td></tr>
    </table>
