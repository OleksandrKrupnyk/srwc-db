...
<form class="addreviewForm form" method="post" action="action.php" id="review-form">
    ...
    <fieldset>
        ...
        <textarea id='review-defects' name="Review[defects]" rows="4" cols="40" maxlength="4096" class="w-100"
                  placeholder="Недоліки роботи по пунктах в яких низька кількість балів або об’єктина оцінка. В середньому 2-4 речення."><?= htmlspecialchars($review['defects']); ?></textarea>
    </fieldset>
    <br>
