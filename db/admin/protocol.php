...
printf("<header>Протокол засідання</header>\n");
...
or die("Помилка запиту: " . mysqli_error($link));
echo "<table>";
echo "<tr><th>Диплом І ступеня, ІІ ступеня, ІІІ ступеня (потрібне зазначити)</th><th>Прізвище, ім’я, по батькові студента (повністю)</th><th>Прізвище, ім’я, по батькові (повністю), посада наукового керівника </th><th>Найменування вищого навчального закладу (повністю)</th></tr>";
